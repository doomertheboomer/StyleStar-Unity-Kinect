...
public class CubemanController : MonoBehaviour 
{
	...
	void Update () 
	{
		...
		// test code to solve kinect consistency
		double lLift = (bones[18].transform.position.y - (((-0.0619077) * bones[18].transform.position.z) + 0.331022));
		double rLift = (bones[14].transform.position.y - (((-0.0619077) * bones[14].transform.position.z) + 0.331022));

		float rSprite = (float)-100;
		float lSprite = (float)-100;
		double errorMargin = 0.035;

		if ((rLift - errorMargin) > lLift)
        {
		...
		else if ((lLift - errorMargin) > rLift)
		{
		...
		FootSpriteL.transform.position = new Vector3((bones[18].transform.position.x) * 5, lSprite, 0);
		FootSpriteR.transform.position = new Vector3((bones[14].transform.position.x) * 5, rSprite, 0);
